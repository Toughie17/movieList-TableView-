...
final class ViewController: UIViewController {
    ...
    lazy var rightButton: UIBarButtonItem = {
        let button = UIBarButtonItem(title: "추가", style: .done, target: self, action: #selector(buttonPressed))
        button.tag = 1
    ...
    @objc func buttonPressed() {
        moviesArray.append(Movie(movieImage: UIImage(named: "spiderman2"), movieName: "스파이더맨2", movieDescription: "요"))
